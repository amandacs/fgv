    ...
    <div class="perguntas form">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <?php echo $this->Form->input('avaliacao_id', array('class' => 'form-control', 'required' => true, 'empty' => 'Selecione a avaliação relacionada a este indicador...'));?>
            </div>
            <div class="form-group">
            ...
            <label class="required" style="margin: 20px 0 10px 0">Classes:</label>
            <div id="perg_box">
            ...
            <label class="required" style="margin: 20px 0 10px 0">Funções:</label>
            <div id="perg_box">
                <?php foreach($funcoes as $id => $funcao):?>
                    <?php $checked=''; ?>
                    <?php if(in_array($id, $this->App->arrayFromDB($this->request->data['Pergunta']['funcao_array']))){
                        $checked = 'checked';
                    }?>
                    <label class="perg_label"><?php echo $this->Form->checkbox('funcao_array', array('hiddenField' => false, 'id'=>'PerguntaFuncaoArray'.$id, 'name'=>'data[Pergunta][funcao_array][]',
                            'label'=>'PerguntaFuncaoArray'.$id, 'value'=>$id, $checked));?><?php echo' '.$funcao;?></label>
                <?php endforeach; ?>
            </div>
                <?php /*echo $this->Form->input('funcao_array', array('type'=>'select', 'options'=>$funcoes, 'multiple'=>'checkbox', 'class'=>'perg_box'));*/?>
