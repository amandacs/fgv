    ...
    <div class="form usuarios_add">
        ...
        <fieldset>
            ...
            <div>
                ...
                <?php echo $this->Form->input('cargo_id', array('type' => 'select', 'options' => $cargos, 'id' => 'cargos', 'class' => 'form-control edit med', 'required' => true, 'empty'=>'Selecione o cargo do usuário...')); ?>
            </div>
            <div class="form-group">
                <label class="required" style="margin-top: 10px;">Classe:</label>
                <?php echo $this->Form->input('classe_id', array('type' => 'select', 'class' => 'form-control med', 'id' => 'classes', 'required' => true, 'empty'=>'Selecione  o cargo do usuário...')); ?>
            </div>
            <div class="form-group">
